...
function Home() {
    return (
        ...
        >
            ...
            <div className="flex justify-end p-6">
                <div className="social flex mr-20">
                    ...
                    <div className="github p-2">
                        <a href="https://github.com/Cipppp" target="_blank">
                            <svg
                                className="w-6"
                                viewBox="0 0 32 32"
                                fill="none"
                    ...
                    <div className="twitter p-2">
                        <a
                            href="https://twitter.com/Cip41388806"
                            target="_blank"
                        >
                            <svg
                                className="w-6"
            ...
            {/* Scroll down button */}
            <div className="">
                <SmoothLink to="services" smooth={true} duration={1000}>
                    <span className="flex justify-center text-white font-bold cursor-pointer">
                        Scroll down
                    </span>
                </SmoothLink>
                <SmoothLink to="services" smooth={true} duration={1000}>
                    <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-6 flex m-auto cursor-pointer"
                    >
                        <path
